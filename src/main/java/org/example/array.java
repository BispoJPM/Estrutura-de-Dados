...
class Arvore {
    ...
    Arvore[] buscaComPai(Arvore raiz, int valor) {
        ...
        return (procurado != null) ? new Arvore[]{pai, procurado} : null;
    }
    ...
    public static void main(String[] args) {
        ...
        Arvore[] resultado = arvore.buscaComPai(raiz, 31);
